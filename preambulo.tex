...
\usepackage{listingsutf8}                           % Suporte a caracteres UTF-8 em ambientes lstlisting
...
\usepackage{unifortex2}		                    % Biblioteca com as normas da Unifor para trabalhos academicos
